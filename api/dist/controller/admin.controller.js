...
exports.rejectBozza = exports.approveScheda = exports.getBozzeForAdmin = void 0;
...
const getBozzeForAdmin = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const result = yield pool.query(admin_query_1.QUERY.SELECT_BOZZE_PER_SCHEDATORE);
        pool.end();
