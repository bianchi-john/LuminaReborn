...
export const QUERY = {
  ...
  CREATE_SCHEDA: (schedaData: SchedaData) => {
    const fields = [
  ...
  CREATE_SCHEDA_AUTORI: (schedaId: number, autoriData: SchedaData) => {
    const autoriQueries: string[] = [];
    const tdsSchedeAutoriQueries: string[] = [];
    const autoriValues: string[] = [];
