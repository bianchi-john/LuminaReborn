...
curl --header "Content-Type: application/json" \  --request POST \  --data '{"id": "1", "curatore": "Curator 1", "titolo_mostra": "Esempio titolo mostra", "data_mostra": "06-12-2022 - 09-12-2022", "luogo_mostra": "esempio luogo mostra", "descrizione": "esempio descrizione della mostra 1"}' \  http://0.0.0.0:3000/mostre
