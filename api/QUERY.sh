...
curl --header "Content-Type: application/json" \  --request POST \  --data '{"id": "1", "ambito_storico": "Basso medioevo", "etichetta_data": " 1340 ca", "data_da": "1098-12-10", "data_a": "1458-10-12"}' \  http://0.0.0.0:3000/cronologie
...
curl --header "Content-Type: application/json" \  --request POST \  --data '{"id": "1", "curatore": "Curator 1", "titolo_mostra": "Esempio titolo mostra", "data_inizio_mostra": "2022-06-12", "data_fine_mostra": "2022-12-02", "luogo_mostra": "esempio luogo mostra", "descrizione": "esempio descrizione della mostra 1"}' \  http://0.0.0.0:3000/mostre
...
curl --header "Content-Type: application/json" \  --request POST \  --data '{"id": "2", "ambito_storico": "Rinascimento", "etichetta_data": "1503-1506", "data_da": "1503-01-01", "data_a": "1506-12-31"}' \  http://0.0.0.0:3000/cronologie
...
curl --header "Content-Type: application/json" \  --request POST \  --data '{"id": "3", "ambito_storico": "Post-Impressionismo", "etichetta_data": "1889", "data_da": "1889-01-01", "data_a": "1889-12-31"}' \  http://0.0.0.0:3000/cronologie
